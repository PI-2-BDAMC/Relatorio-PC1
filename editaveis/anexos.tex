...
\chapter{Protótipo de Baixa Fidelidade da Interface Gráfica}

Criou-se um protótipo de baixa fidelidade da interface gráfica no intuito de tornar mais clara  a visão de como o usuário da bancada irá interagir com o sistema durando o ensaio de análise do motor a combustão. A Figura \ref{fig:telainicial} ilustra a tela inicial da aplicação WEB que está sendo proposta.

\begin{figure}[h!]
	\centering
	\includegraphics[keepaspectratio=true,scale= 0.23]{figuras/telainicial.png}
	\caption{Tela Inicial do Protótipo de Baixa Fidelidade.}
	\label{fig:telainicial}
\end{figure}

Após o início do ensaio, o usuário será apresentado à tela de análise onde o mesmo terá acesso a elementos dinâmicos (velocímetros, termômetros e mostradores), bem como a gráficos referentes as informações oriundas dos sensores acoplados ao motor, como ilustrado na Figura \ref{fig:teladeanalise}. 

\begin{figure}[h!]
	\centering
	\includegraphics[keepaspectratio=true,scale= 0.23]{figuras/teladeanalise.png}
	\caption{Tela de Análise do Protótipo de Baixa Fidelidade.}
	\label{fig:teladeanalise}
\end{figure}
